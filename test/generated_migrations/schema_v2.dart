...
class Apps extends Table with TableInfo<Apps, AppsData> {
  ...
  @override
  List<GeneratedColumn> get $columns => [packageName, name, version];
  @override
...
class AppsData extends DataClass implements Insertable<AppsData> {
  ...
  const AppsData({required this.packageName, required this.name, required this.version});
  @override
  ...
  @override
  int get hashCode =>
      Object.hash(packageName, name, version);
  @override
